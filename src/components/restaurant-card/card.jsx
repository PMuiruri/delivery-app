...
const Card = (props) =>{
  ...
  useEffect(() => {
    ...
    const res = await fetch(`https://reverse.geocoder.ls.hereapi.com/6.2/reversegeocode.json?prox=${props.location[1]}%2C${props.location[0]}%2C250&mode=retrieveAddresses&maxresults=1&gen=9&apiKey=EgJds5TXQk9olqJ7xETeBjSrMGltutSn-CfdATn4-QQ`);
